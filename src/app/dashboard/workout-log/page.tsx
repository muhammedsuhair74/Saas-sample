// src/pages/dashboard/workout-log.tsx
"use client";

import WorkoutDropdown from "@/components/workoutDropDown"; // Dropdown for workout types
import { useSession } from "next-auth/react"; // Assuming you're using next-auth for user session
